...
! function () {
    Lungo.RouterTablet = function (a) {
        ...
        e = function (c, d, e) {
            var g;
            if (!t() && c !== a.Element.Cache.section.attr("id")) {
                f(false)
            }
            g = a.dom("article#" + d);
            if (g.length > 0) {
        ...
        y = function (c) {
            var d, e, f, g;
            d = a.Element.Cache.section;
            a.Section.show(void 0, c);
            e = ((f = a.Element.Cache.section) != null ? f.data("aside") : void 0) != null;
            if (!n || !((g = a.Element.Cache.section) != null ? g.data("aside") : void 0)) {
        ...
        z = function (c) {
            ...
            f = a.dom(b.QUERY.ARTICLE_ROUTER).removeClass(b.CLASS.ACTIVE);
            f.filter("[data-view-article=" + c + "]").addClass(b.CLASS.ACTIVE);
            g = a.Element.Cache.section.find(b.QUERY.ARTICLE_REFERENCE).addClass(b.CLASS.HIDE);
            g.filter("[data-article~='" + c + "']").removeClass(b.CLASS.HIDE);
            if (a.Element.Cache.aside) {
...
! function () {
    Lungo.Boot.Device = function (a) {
        ...
        c = function () {
            ...
            a.DEVICE = d.screen.width < 1536 ? b.PHONE : b.TABLET;
...
! function () {
    Lungo.Boot.Layout = function (a) {
        ...
        h = function () {
            var b, d, e, f, g, h;
            d = window.location.hash.replace(c, "").split("http://lungo.tapquo.com/");
            f = d[d.length - 2];
            b = d[d.length - 1];
            if (d.length > 2) {
                d.length -= 2;
